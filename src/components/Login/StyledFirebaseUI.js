module.exports = function(i) {
    ...
    return o.m = i, o.c = e, o.d = function(i, e, t) {
        ...
        if (o.r(t), Object.defineProperty(t, "default", {
            ...
            for (var a in i) o.d(t, a, function(e) {
                return i[e]
            }.bind(null, a));
        return t
    }, o.n = function(i) {
    ...
    function p(i, e) {
        for (var o = 0; o < i.length; o++) {
            ...
            if (r) {
                ...
                for (; n < a.parts.length; n++) r.parts.push(x(a.parts[n], e))
            } else {
                var l = [];
                for (n = 0; n < a.parts.length; n++) l.push(x(a.parts[n], e));
                t[a.id] = {
                    id: a.id,
                    refs: 1,
                    parts: l
    ...
    function f(i, e) {
        ...
        var t = s[s.length - 1];
        if ("top" === i.insertAt) t ? t.nextSibling ? o.insertBefore(e, t.nextSibling) : o.appendChild(e) : o.insertBefore(e, o.firstChild), s.push(e);
    ...
    function h(i, e, o, t) {
        var a = o ? "" : t.css;
        if (i.styleSheet) i.styleSheet.cssText = m(e, a);
        else {
    ...
    i.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(i, e) {
            var a, r = e.trim().replace(/^"(.*)"$/, function(i, e) {
                return e
